...
def main():
    ...
    feature_names = [
        ...
        "TotRmsAbvGrd",
        "HouseStyle",
    ]  # TASK: Define the names of the columns to keep
    ...
    numerical_features = [
        ...
        "BedroomAbvGr",
        "TotRmsAbvGrd",
    ]  # TASK: Define numerical column names
    categorical_features = [
        "HouseStyle",
    ]  # TASK: Define categorical column names
    ...
    x_train, x_test, y_train, y_test = train_test_split(
        input_data, output_var, random_state=42, test_size=0.3
    ...
    print("####################")
    print("RMSE: {:.2f}".format(np.sqrt(mean_squared_error(y_test, pred_test))))
    ...
    """
    compare = pd.DataFrame({"Actual": y_test, "Predicted": pred_test})
